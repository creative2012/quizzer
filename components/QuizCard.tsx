...
import { SiJavascript, SiMongodb, SiReact, SiVuedotjs, SiPrisma } from 'react-icons/si';
import { TbBrandNextjs } from 'react-icons/tb';
import Rating from '@mui/material/Rating';
import { CircularProgress } from '@mui/material';import { styled } from '@mui/material/styles';
...
const QuizCard: React.FC<QuizCardProps> = ({ data }) => {
  ...
  return (
    <HtmlTooltip arrow enterDelay={500} 
        title={
          <React.Fragment>
            <Typography color="inherit" className="font-bold">{data.title}</Typography>
            {data.description}
          </React.Fragment>
        }
      >
    <div
      ...
      className='w-[300px] group text-xl flex flex-col gap-8 shadow-md p-4 bg-[#f0f0fa] text-zinc-800 rounded-md cursor-pointer hover:shadow-lg transition transform hover:scale-110'
    >
